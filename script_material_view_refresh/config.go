...
func ParseConfig() Config {
	...
	interval := flag.Duration("interval", durationEnv("MV_INTERVAL", 5*time.Millisecond), "Polling interval per goroutine")
	...
	observe := flag.Duration("observe", durationEnv("MV_OBSERVE", 100*time.Second), "Observation window after triggering the script")
